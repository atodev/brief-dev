# Real-Time Observation Example: After-Hours Surge

## Scenario: Tesla Climbs 8% After Market Close

**Date**: Tuesday, January 7, 2026  
**Time**: 4:00 PM ET → Market closes  
**Event**: Tesla announces surprise Q4 delivery numbers
...
4. ✅ Checked portfolio database: 3,847 Brief users hold TSLA
5. ✅ Calculated impact: Potential +$8-15 per share by market open

### 4:20 PM ET - Alert Sent to TSLA Holders

**Push Notification** (3,847 users receive this):

```
🚨 PORTFOLIO ALERT: Tesla (TSLA)

Your Position: 50 shares @ $242.80

🔥 AFTER-HOURS SURGE: +2.9% ($252.40)

What Happened:
Tesla crushed Q4 delivery estimates by 18%
(525K delivered vs 445K consensus)

Current Price Action:
• After-hours: $252.40 (+$7.10)
• Volume: 3.2M (10x normal)
...
### 4:25 PM ET - Detailed Observation Posted (Community)

Brief automatically posts to **#tesla-tsla** channel:

---

## 📊 After-Hours Observation: TSLA

**Posted by**: Brief AI Avatar  
**Time**: 4:25 PM ET (Market closed)  
**Urgency**: HIGH 🔴
...
- **Market Reaction**: Stock up +2.9% after-hours ($252.40)
...
**If pattern holds**: $245.30 → $275 target (+12%) = **+$29.70 per share**

---

### Strategy Options (Before Market Opens Tomorrow)

We've identified 4 strategies based on your risk profile. Choose the one that fits YOUR situation:

---

#### 🟢 Strategy 1: HOLD & RIDE (Conservative)
...
**Probability**: 70% chance of +8% or better

---

#### 🟡 Strategy 2: ADD MORE (Moderate)
...
**Probability**: 60% chance of +10% or better

---

#### 🟠 Strategy 3: TAKE PROFITS (Risk-Averse)
...
**Probability**: 100% you lock in gains, 60% remaining position gains more

---

#### 🔴 Strategy 4: SHORT-TERM TRADE (Aggressive)
...
**Probability**: 65% chance of +5% or better within 2 days

---

### Key Invalidation Signals (Exit Immediately)
...
### What We're Watching Tonight (5 PM - 9:30 AM)
...
### Morning Briefing Update (Posted at 6:00 AM)

**We'll send you a final update at 6:00 AM ET** with:

✅ Overnight developments (analyst upgrades, news, etc.)  
✅ Pre-market price action (opens at 4:00 AM ET)  
✅ Refined strategy based on overnight data  
✅ Exact entry/exit prices for each strategy  
✅ Risk level update (any new red flags?)

**Set your alarm**: Be ready to act at 9:30 AM open! ⏰

---

### Community Discussion (Live Updates)
...
### Data Sources (This Observation)

- ✅ Tesla press release (official)
- ✅ After-hours data: Nasdaq.com (real-time)
- ✅ Historical pattern analysis: Brief database (6 prior events)
- ✅ Analyst estimates: Bloomberg consensus
- ✅ Social sentiment: Twitter API (18,400 mentions in 20 minutes)
- ✅ Options flow: Unusual Whales
- ✅ Short interest: S3 Partners

**Data freshness**: All data <20 minutes old

---

### Compliance Notice

⚠️ **This is a market observation and educational content, NOT financial advice.**
...
- Consult a licensed financial advisor if unsure

**This is information. You make the decisions.** 📊

---

### Summary: What You Need to Know

**The News**: Tesla beat Q4 delivery estimates by 18%

**The Move**: +2.9% after-hours ($252.40), suggesting gap-up open tomorrow
...
4. 🔴 **Trade It**: Quick +5-8% flip in 1-2 days (65% probability)

**The Timing**: Market opens 9:30 AM ET (17 hours from now)
