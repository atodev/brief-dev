# Broker Partnerships & Account Setup Assistance

## Overview

Brief doesn't just give investment advice—we **help you take action** by connecting you with the right broker for your location, asset class, and needs. When Brief recommends an opportunity, we ensure you can actually execute on it.
...
- Recommend best option: "Hatch has lowest fees for US stocks from NZ"
- **One-click**: "Open Hatch account through Brief (5 minutes)"
- Track setup: Guide user through KYC
- Connect account: Link to Brief for portfolio tracking
- Execute: "Place order through Hatch"

**Result**: User goes from recommendation → execution in 10 minutes, not 3 days
...
4. **Fee Transparency**: Competitive pricing
5. **Reputation**: Regulated, trusted, established
6. **Affiliate Program**: Revenue share for referrals

---

## Broker Affiliate List (By Region)
...
- **KYC Time**: 5-10 minutes
- **Unique Feature**: Fractional shares
- **Brief Affiliate Deal**: $25 per referral
- **Why Best**: Lowest fees for US stocks, easiest onboarding
...
- **KYC Time**: 5 minutes
- **Unique Feature**: NZ/AU market access
- **Brief Affiliate Deal**: $20 per referral
- **Why Good**: Best for local NZ stocks
...
- **KYC Time**: 10-15 minutes
- **Unique Feature**: Asian market access
- **Brief Affiliate Deal**: $30 per referral
- **Why Good**: Multi-market access
...
- **KYC Time**: 1-3 days (bank account required)
- **Why Consider**: Trusted bank-backed
- **Limitations**: High fees, slow setup
...
- **Fees**: 0.5-1% spread
- **KYC Time**: 5 minutes
- **Brief Affiliate Deal**: $15 per referral
- **Why Best**: NZ-based, regulated, easy
...
- **KYC Time**: 10 minutes
- **Brief Affiliate Deal**: 20% commission on trading fees
- **Why Good**: Largest exchange, lowest fees
- **Limitations**: Regulatory concerns, complex interface
...
- **KYC Time**: 15 minutes
- **Brief Affiliate Deal**: CPA $400 per funded account
- **Why Best**: Regulated, transparent pricing
- **Limitations**: Forex only, no stocks
...
- **KYC Time**: 1-2 days
- **Brief Affiliate Deal**: $200 CPA (funded account >$10K)
- **Why Good**: Professional-grade, global access
- **Limitations**: Complex, $10K minimum for best rates
...
- **KYC Time**: 10 minutes
- **Brief Affiliate Deal**: $50 per referral
...
- **KYC Time**: 5 minutes
- **Brief Affiliate Deal**: $80 per funded account
...
- **Why Good**: Professional platform
...
- **KYC Time**: 10 minutes
- **Brief Affiliate Deal**: CPA $200-600
- **Why Good**: Social trading features
- **Limitations**: Not available in US
...
- **Fees**: $0 commission
- **KYC Time**: 5 minutes
- **Brief Affiliate Deal**: $10-30 per referral
- **Why Best**: Simple, popular, zero fees
...
- **Fees**: $0 commission
- **KYC Time**: 5 minutes
- **Brief Affiliate Deal**: Free stocks promo (revenue share)
...
- **Fees**: $0-1 per trade
- **Brief Affiliate Deal**: $200 CPA
- **Why Best**: Professional platform, global access
...
- **Brief Affiliate Deal**: Not available (work in progress)
...
- **KYC Time**: 1-2 days (thorough)
- **Minimum**: $0 (but $10K for best rates)
- **Brief Affiliate Deal**: $200 CPA for funded accounts
- **Why Best**: True global access, professional tools
- **For**: Experienced investors, high net worth
...
- **KYC Time**: 10 minutes
- **Minimum**: $50-200 (varies by region)
- **Brief Affiliate Deal**: CPA $200-600 depending on deposit
- **Why Good**: Social trading, copy trading
...
- **Fees**: Spread-based
- **Brief Affiliate Deal**: CPA £250-800
- **Why Consider**: 50-year history, regulated
...
```python
def recommend_broker(user, opportunity):
    """
    Recommend best broker based on user location and opportunity
    """
...
def calculate_broker_score(broker, user, opportunity):
    """
...
# Example:
user = User(country="New Zealand", available_capital=500)
opportunity = Opportunity(ticker="TSLA", price=242, asset_class="US Stocks")

recommendations = recommend_broker(user, opportunity)

# Output:
[
    (Hatch, 87.5),      # Best for NZ + US stocks
    (Stake, 85.2),      # Alternative (zero fees)
    (Tiger Brokers, 78.3)  # Good but higher minimum
]
```

---

## User Flow: Account Setup Assistance
...
def check_user_trading_readiness(user, opportunity):
    ...
    """
    checks = {
        'has_broker_account': user.linked_brokers.count() > 0,
        'broker_supports_asset': False,
...
📍 You're in: Auckland, New Zealand

🏆 BEST OPTION: Hatch

Why Hatch?
✅ Lowest fees for US stocks from NZ ($3 per trade)
✅ Setup time: 5 minutes
✅ No minimum deposit
✅ Fractional shares (buy $100 of Tesla, not whole share)
✅ Brief users save $25 (signup bonus)
...
Stake - $0 brokerage, but 0.7% FX fee ($3.50)
Tiger Brokers - $1.99 fee, but $500 minimum deposit

💡 Brief Recommends: Hatch

[OPEN HATCH ACCOUNT] [SEE ALTERNATIVES] [I ALREADY HAVE A BROKER]
```

**Step 5: User Clicks "Open Hatch Account"**
...
2. Upload ID
3. Verify address
4. Link bank account (for deposits)
5. Complete risk assessment
6. Sign terms & conditions
...
Your account is ready. You can now invest in US stocks.

Next steps:
1. Deposit NZD to Hatch (bank transfer, 1-2 business days)
2. Once funds arrive, you can buy Tesla

Want to deposit now?
[DEPOSIT TO HATCH] [I'LL DO IT LATER]

⏰ Reminder: Tesla opportunity expires in 48 hours
```
...
Benefits:
✅ See Hatch holdings in Brief app
✅ Get alerts when your stocks are affected by news
✅ Track performance in one place
✅ AI recommendations based on your actual portfolio
...
You're ready to invest in Tesla through Hatch.

Deposit status: Pending (funds arriving in 1-2 days)

We'll notify you when:
• Your deposit clears
• Tesla opportunity is still available
• Better buying moment appears
...
## KYC Assistance Features

### Pre-KYC Checklist

Before users start KYC, Brief prepares them:
...
✅ Personal Information
   ...
   • Tax ID number (IRD number for NZ)

✅ Identity Verification
   • Passport OR Driver's License
   • Take photo of ID (clear, not blurry)
   • Selfie (to match your ID photo)

✅ Address Verification
   • Bank statement (within 3 months)
   • Utility bill (within 3 months)
   • OR government letter
...
💡 Tip: Have your ID and bank statement ready before starting
```
...
Brief tracks KYC status and nudges user:

```python
def track_kyc_progress(user, broker):
    """
    ...
    statuses = {
        ...
        'pending_id': {
            'message': '{broker} is waiting for your ID photo. Upload now?',
            'action': 'UPLOAD ID',
            'urgency': 'HIGH'
        },
        'pending_address': {
            'message': '{broker} needs proof of address. Upload bank statement?',
            'action': 'UPLOAD DOCUMENT',
            'urgency': 'HIGH'
        },
        'under_review': {
            'message': '{broker} is reviewing your application. Usually takes 1-24 hours.',
            'action': None,
            'urgency': 'LOW'
        },
        'approved': {
            'message': '🎉 {broker} account approved! You can now invest.',
            'action': 'DEPOSIT FUNDS',
            'urgency': 'MEDIUM'
        },
        'rejected': {
            'message': '{broker} couldn't verify your account. Contact their support or try alternative broker.',
...
# Send reminders:
# Day 1: User starts KYC, doesn't finish → Reminder in 6 hours
# Day 2: Still not finished → Reminder + "Opportunity closing soon"
# Day 3: Still not finished → Suggest alternative broker with faster KYC
```
...
If user's KYC is rejected:

```
❌ Hatch Account Application Issue

Reason: Address verification failed
(Your bank statement address doesn't match ID address)

What to do:
1. Update your bank address to match your ID
2. Wait for new statement (or request from bank)
3. Resubmit to Hatch

OR

Try alternative broker:
Sharesies accepts wider range of address documents
(Rates bill, tenancy agreement, etc.)

[CONTACT HATCH SUPPORT] [TRY SHARESIES] [UPDATE INFO]
```
...
⚠️ Limited Broker Options for US Stocks

Unfortunately, Hatch, Stake, and Robinhood are not available in the Philippines.
...
💡 Brief Recommends:
• If you have <$5K: Tiger Brokers (easier)
• If you have >$10K: Interactive Brokers (professional)

[OPEN TIGER BROKERS] [OPEN INTERACTIVE BROKERS] [LEARN MORE]
```
...
**Total Year 3**: $11.25M (CPA) + $2.4M (rev share) = **$13.65M from broker affiliates**
...
## Email Template for CEO/CFO

**Subject**: Partnership Opportunity - Brief AI Financial Advisor

```
Hi [Broker CEO/Partnerships Team],

I'm the CEO of Brief, an AI-powered financial advisor launching in [Month/Year].

Brief provides personalized investment recommendations to retail investors using alternative data (satellite imagery, foot traffic, social sentiment) and AI. We're already generating significant user interest in [Country/Region].

We'd like to partner with [Broker Name] as a preferred broker for our users.

Why partner with Brief?

• User volume: Projected 10,000 users in first 6 months
• High intent: Users receive specific "buy Tesla" recommendations and need immediate execution
• Qualified leads: Users complete our onboarding, so they're ready to trade
• Revenue for you: Average user deposits $2,000-5,000 initially
• No cost to you: Standard affiliate CPA or revenue share

What we're looking for:

• Competitive CPA rate ($50-75 per funded account)
• OR revenue share (10-20% of trading fees)
• API access for portfolio sync (read-only)
• Co-marketing opportunities

Our users are in: [NZ, Australia, Singapore, etc.]

Are you open to discussing this? Happy to share more details on a call.
...
## Alternative Options by Region (Quick Reference)
...
- By not executing trades, Brief avoids:
  ...
  - Trade execution infrastructure (costly)
  - FINRA membership fees (US)
...
By helping users not just with WHAT to invest in, but also HOW and WHERE to execute, Brief becomes a complete solution. This:

1. **Reduces friction** → Higher user satisfaction
2. **Captures affiliate revenue** → $13M+ annually by Year 3
3. **Deepens engagement** → Portfolio tracking keeps users in app
4. **Competitive moat** → Ecosystem lock-in (advice + execution)

**The Vision**: "From insight to execution in 10 minutes, not 3 days" 🚀
